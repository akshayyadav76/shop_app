...
void removeSingleItem(String id){
    ...
    if(_cartaItems[id].quantity >1){
      _cartaItems.update(id, (exitingItems)=>CartItem(
        id: exitingItems.id,
        price: exitingItems.price,
        title: exitingItems.title,
        quantity: exitingItems.quantity -1,
      ));
    }else{
